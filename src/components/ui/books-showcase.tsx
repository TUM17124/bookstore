    ...
    >
      ...
      >
        &#10005;
          ...
          ref={dpRef}
          aria-live="polite"
          className={`absolute right-[5%] top-16 bottom-4 z-[15] flex w-[min(520px,40%)] flex-col justify-start pt-0 pointer-events-none
            @max-[760px]:right-auto @max-[760px]:left-1/2 @max-[760px]:top-[40%] @max-[760px]:bottom-4
